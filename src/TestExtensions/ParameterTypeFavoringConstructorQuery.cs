...
namespace Natsnudasoft.NatsnudaLibrary.TestExtensions
{
    ...
    public sealed class ParameterTypeFavoringConstructorQuery : IMethodQuery
    {
        ...
        /// <summary>
        /// Extracts the constructor from the specified <see cref="Type"/> whose parameters match
        /// the types specified by this <see cref="ParameterTypeFavoringConstructorQuery"/>.
        /// </summary>
        /// <param name="type">The type to extract the constructor from.</param>
        /// <returns>
        /// A sequence which contains the constructor method that was matched.
        /// </returns>
